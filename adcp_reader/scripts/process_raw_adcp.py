...
''' 
This file contains key functions to extract a raw adcp reading.
If you want it to return specific values from the adcp, look
at the "extract_data" function below. For example,
right now it is only returning 

relative velocities[0] (the top cell), depth, bottom track ranges,
velocities...

you can add more as you see fit. This is python, so just get the values
that you want and return it at the end of the function. 
